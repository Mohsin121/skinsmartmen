...
import { MessageCircle, Settings, User, Droplet, Sprout, Edit, Trash2 } from 'lucide-react';
...
const SideBar = () => {
    ...
    return (
<aside className="relative flex flex-col h-screen w-64 
    p-3 bg-white/85 backdrop-blur-lg border-r border-[#E7EAE5]">
    ...
    <div className="flex flex-col h-full">
        ...
        <div className="flex items-center justify-center  shrink-0 ">
            <img 
                ...
                className="sidebar-logo" // Assign a specific class for targeting
            />
        </div>
