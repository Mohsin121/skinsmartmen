    ...
    <div className="h-screen flex items-center justify-center bg-gradient-to-b from-white to-[#F5F7F0] ">
      <div className="w-full max-w-2xl mx-auto text-center">
        ...
        <div className="flex items-center justify-center mb-6">
          ...
          <h1 className="text-3xl md:text-4xl font-bold text-[#A2AA7B]">
            SkinSmart AI
          </h1>
        </div>
        ...
        <div className="space-y-3 mb-6">
          <h2 className="text-2xl md:text-3xl font-semibold text-[#5C6748]">
            Welcome to Your Personal Skin Care Assistant
          </h2>
          
          <p className="text-base md:text-lg text-[#5C6748]/80 max-w-2xl mx-auto leading-relaxed">
        ...
        >
          Start Conversation with SkinSmart AI →
        </Link>
